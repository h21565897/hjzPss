package com.example.pss.cron.pending;
...
import com.example.pss.cron.constants.PendingConstant;
...
import com.example.pss.support.pending.PendingParam;
...
public class CrowdBatchTaskPending extends AbstractLazyPending<CrowdInfoVo> {
    ...
    public CrowdBatchTaskPending() {
        ...
        pendingParam.setQueue(new LinkedBlockingQueue(PendingConstant.QUEUE_SIZE))
                ...
                .setNumThreshold(pssConstant.BATCH_RECEIVER_SIZE)

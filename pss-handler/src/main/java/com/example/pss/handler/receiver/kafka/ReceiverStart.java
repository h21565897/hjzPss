...
public class ReceiverStart {
     ...
     */
    @Bean
    public ConcurrentKafkaListenerContainerFactory filterContainerFactory(@Value("${pss.business.tagId.key}") String tagIdKey,
                                                                          @Value("${pss.business.tagId.value}") String tagIdValue) {

...
import com.example.pss.common.dto.account.DingDingRobotAccount;
import com.example.pss.common.dto.model.DingDingRobotContentModel;
import com.example.pss.common.enums.ChannelType;
import com.example.pss.common.enums.SendMessageType;
import com.example.pss.handler.domain.dingding.DingDingRobotParam;
import com.example.pss.handler.domain.dingding.DingDingRobotResult;
...
public class DingDingRobotHandler extends BaseHandler implements Handler {
    ...
    private DingDingRobotParam assembleParam(TaskInfo taskInfo) {
        ...
        if (pssConstant.SEND_ALL.equals(CollUtil.getFirst(taskInfo.getReceiver()))) {

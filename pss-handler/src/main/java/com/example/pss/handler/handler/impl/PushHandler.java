...
import com.example.pss.common.constant.SendAccountConstant;
import com.example.pss.common.domain.TaskInfo;
import com.example.pss.common.dto.account.GeTuiAccount;
import com.example.pss.common.dto.model.PushContentModel;
import com.example.pss.common.enums.ChannelType;

import com.example.pss.handler.domain.push.PushParam;
import com.example.pss.handler.domain.push.getui.BatchSendPushParam;
import com.example.pss.handler.domain.push.getui.SendPushParam;
import com.example.pss.handler.domain.push.getui.SendPushResult;
...
public class PushHandler extends BaseHandler implements Handler {
    ...
    public boolean handler(TaskInfo taskInfo) {
        ...
        try {
            ...
            // 常见的错误 应当 关联至 AnchorState,由pss后台统一透出失败原因

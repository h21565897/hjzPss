...
import com.example.pss.common.domain.SimpleAnchorInfo;
...
import com.example.pss.support.utils.RedisUtils;
import com.example.pss.support.utils.TaskInfoUtils;
...
public class DataServiceImpl implements DataService {
    ...
    private String getRealBusinessId(String businessId) {
        if (pssConstant.BUSINESS_ID_LENGTH == businessId.length()) {
            return businessId;
        }
